...
browser = webdriver.Chrome(executable_path=r'C:\Users\Posma Panggabean\PycharmProjects\drivers\chromedriver.exe')

browser.set_page_load_timeout(10)
browser.get('https://user.hadirr.com/r4h514/170700004')
